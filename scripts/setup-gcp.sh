...
echo "DEV_REDIS_HOST=  # Leave empty - Redis not required for Cloud Run"
echo "DEV_REDIS_PASSWORD=  # Leave empty"
...
echo "PROD_REDIS_HOST=  # Leave empty - Redis not required for Cloud Run"
echo "PROD_REDIS_PASSWORD=  # Leave empty"
echo "PROD_APP_KEY=${APP_KEY}"
echo "PROD_STORAGE_BUCKET=revenge-x-hq-prod-apk"
echo ""
echo -e "${RED}IMPORTANT: Set strong passwords for DB! Redis not required.${NC}"
echo ""
